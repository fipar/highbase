...
* ===================== IMPORTANT NOTICE ===========================
* this program was taken from the fake application. this application is released under
* the GNU GPL, but this source file does not include any licencing information. 
* you can read the comments above for more info, aswell as the author's e-mail
* Fernando Ipar
