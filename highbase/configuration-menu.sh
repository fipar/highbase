...
echo "adding $HIGHBASE_HOME/role.include to $BASHRC";echo 
...
while [ $NODE -ne 0 -a $NODE -ne 1 ] ; do
	...
	[ $NODE -eq 0 ] && cp -f $HIGHBASE_HOME/master.include $HIGHBASE_HOME/role.include
	[ $NODE -eq 1 ] && cp -f $HIGHBASE_HOME/slave.include $HIGHBASE_HOME/role.include
done
